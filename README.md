...
- **Language（语言）**：如果你需要中英混排，英文文献请在 Zotero 中明确填写 `en`；中文文献请留空。当前版本用 `Language` 字段区分中英文分支，中文若填写 `zh-CN` 可能无法按中文分支处理。
...
- 2026/04/05 修复样式安装兼容性；将非法的 locale 条件改为基于 `Language` 字段的合法 CSL 分流；修复英文同年同首作者文内引用显示为 `2021a/2021b`
- 2026/04/02
